...
import nex_rise from '../next_rise.png';
...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto" style={{height: "70px"}}>
        <Link
          to="/"
...
style={{width: "15rem"}}
          />
          {/* <img src={nex_rise} alt="Next Rise" /> */}
